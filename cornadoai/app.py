...
def ExamineImage():
    ...
    if request.method == 'POST':
        ...
        image.save('webTestFile.png')
        # return "Check if image has been saved"
        data = backend_do_labeling('webTestFile.png')
...
def GetImage():
    if request.method == 'GET':
        return send_file('webTestFile.png', mimetype='image')


@app.route('/correct', methods=["GET", "POST"])
def labelCorrect():
    try:
        os.rename("webTestFile.png",
                  "cornadoai/tf_files/cornPhotos/"
